  ...
  game1: {
    ...
    weeks: [
      ...
      },
      {
        week: 11,
        title: "総合制作準備",
        description: "グループで「操作することで生まれる、新しい音楽体験」を提案・制作する総合制作課題に取り組む。役割分担（サウンド・プログラム・ビジュアル・企画／発表）を決め、企画から発表（第12〜15回）までの進め方と制作課題テンプレートを確認する。",
        slides: [
